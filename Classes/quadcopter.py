...
ACC_PITCH_BIAS = 0.85 # BIAS in degrees (more negative steers more forward, more positive steers more backward)
ACC_ROLL_BIAS = -0.15 # BIAS in degrees (more negative steers more right, more positive steers more left)
PITCH_TRIM = 0.0
ROLL_TRIM = 0.0
